            ...
            try:
                ...
                if analysis_mode == "multi_year":
                    ...
                    if comparison_results and 'matches_df' in comparison_results:
                        ...
                        # FIXED: Handle new defects with realistic growth rates
                        defects_df = datasets[selected_year]['defects_df']
                        ...
                        if new_defect_indices:
                            ...
                            for new_idx in new_defect_indices:
                                growth_rates_dict[new_idx] = {
                                    'depth_growth_pct_per_year': conservative_depth_growth,
                                    'length_growth_mm_per_year': conservative_length_growth,
                                    'width_growth_mm_per_year': conservative_width_growth
                                }

                # Run prediction analysis with FIXED growth rate estimation
                try:
    ...
    **Chart Explanation:**
    ...
    with result_tabs[1]:
        ...
        **Growth Rate Estimation** (Single File Mode):
        ...
        - Applies realistic minimum growth rates

...
def apply_navigation_styles():
    ...
    .professional-metric.success { border-left-color: #059669; }
    .professional-metric.warning { border-left-color: #d97706; }
    .professional-metric.primary { border-left-color: var(--primary-blue); }

...
def get_logo_base64():
    """
    Get base64-encoded inline SVG logo for display.
    """
    return (
        "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAwIiBoZWlnaHQ9IjIwMCIg"
        "dmlld0JveD0iMCAwIDIwMCAyMDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+"
        "PGcgZmlsbD0ibm9uZSIgZmlsbC1ydWxlPSJldmVub2RkIj48Y2lyY2xlIGZpbGw9IiMzNDk4ZGIi"
        "IGN4PSIxMDAiIGN5PSIxMDAiIHI9IjEwMCIvPjxyZWN0IGZpbGw9IiNmZmYiIHg9IjQwIiB5PSI3"
        "MCIgd2lkdGg9IjEyMCIgaGVpZ2h0PSIyMCIgcng9IjUiLz48cmVjdCBmaWxsPSIjZmZmIiB4PSI0"
        "MCIgeT0iMTEwIiB3aWR0aD0iMTIwIiBoZWlnaHQ9IjIwIiByeD0iNSIvPjxjaXJjbGUgZmlsbD0i"
        "I2U3NGMzYyIgY3g9IjU1IiBjeT0iODAiIHI9IjgiLz48Y2lyY2xlIGZpbGw9IiNlNzRjM2MiIGN4"
        "PSIxNDAiIGN5PSIxMjAiIHI9IjgiLz48L2c+PC9zdmc+"
    )
